...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'galter_user.registration.form.type' => 'getGalterUser_Registration_Form_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 8889, 'dbname' => 'toto', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Qcm/SalleTpBundle/Resources/config/doctrine') => 'Qcm\\SalleTpBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Qcm\\SalleTpBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Qcm/TestBundle/Entity'))), 'Qcm\\TestBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('QcmSalleTpBundle' => 'Qcm\\SalleTpBundle\\Entity', 'QcmTestBundle' => 'Qcm\\TestBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_47862eca19b17f0d9c808a49f5c7661a60d5e960c44e9ed52daf5ab418a47840');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Qcm\\TestBundle\\Entity\\Etudiant');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Qcm\\TestBundle\\Entity\\Etudiant');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'GAlter_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Qcm\\TestBundle\\Entity\\Etudiant');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Qcm\\TestBundle\\Entity\\Etudiant');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Qcm\\TestBundle\\Entity\\Etudiant');
    }
    ...
    /**
     * Gets the 'galter_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Qcm\TestBundle\Form\Type\RegistrationFormType A Qcm\TestBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getGalterUser_Registration_Form_TypeService()
    {
        return $this->services['galter_user.registration.form.type'] = new \Qcm\TestBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('kaberleroi007@gmail.com');
        $a->setPassword('kaber1552008');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Qcm/SalleTpBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Qcm/TestBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Qcm/SalleTpBundle/Resources/views'), 'QcmSalleTp');
        $instance->addPath(($this->targetDirs[3].'/src/Qcm/TestBundle/Resources/views'), 'QcmTest');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/Qcm/SalleTpBundle/Resources/config/validation.yml')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'QcmSalleTpBundle' => 'Qcm\\SalleTpBundle\\QcmSalleTpBundle',
                'QcmTestBundle' => 'Qcm\\TestBundle\\QcmTestBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'kaberleroi007@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'kaber1552008',
            ...
            'fos_user.model.user.class' => 'Qcm\\TestBundle\\Entity\\Etudiant',
            ...
            'fos_user.registration.form.type' => 'GAlter_user_registration',
