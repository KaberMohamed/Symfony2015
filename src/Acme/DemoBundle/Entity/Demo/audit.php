...
class audit
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="rapport", cascade={"persist"})
     */
    private $rapport;
    /**
     * @var \DateTime
     ...
     * Set rapport
     *
     * @param \Acme\DemoBundle\Entity\Demo\rapport $rapport
     * @return audit
     */
    public function setRapport(\Acme\DemoBundle\Entity\Demo\rapport $rapport = null)
    {
     ...
     * Get rapport
     *
     * @return \Acme\DemoBundle\Entity\Demo\rapport 
     */
